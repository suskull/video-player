...
function _createClass(e2, t, n) {
  return t && _defineProperties(e2.prototype, t), n && _defineProperties(e2, n), e2;
}
function _defineProperty(e2, t, n) {
...
function _objectSpread2(e2) {
  for (var t = 1; t < arguments.length; t++) {
    ...
    t % 2 ? ownKeys(Object(n), true).forEach(function(t2) {
      _defineProperty(e2, t2, n[t2]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e2, Object.getOwnPropertyDescriptors(n)) : ownKeys(Object(n)).forEach(function(t2) {
      Object.defineProperty(e2, t2, Object.getOwnPropertyDescriptor(n, t2));
    });
  }
  return e2;
}
...
var instanceOf$1 = function(e2, t) {
  return !!(e2 && t && e2 instanceof t);
};
var isNullOrUndefined$1 = function(e2) {
  return null == e2;
};
var isObject$1 = function(e2) {
  return getConstructor$1(e2) === Object;
};
var isNumber$1 = function(e2) {
  return getConstructor$1(e2) === Number && !Number.isNaN(e2);
};
var isString$1 = function(e2) {
  return getConstructor$1(e2) === String;
};
var isBoolean$1 = function(e2) {
  return getConstructor$1(e2) === Boolean;
};
var isFunction$1 = function(e2) {
  return getConstructor$1(e2) === Function;
};
var isArray$1 = function(e2) {
  return Array.isArray(e2);
};
var isNodeList$1 = function(e2) {
  return instanceOf$1(e2, NodeList);
};
var isElement$1 = function(e2) {
  return instanceOf$1(e2, Element);
};
var isEvent$1 = function(e2) {
  return instanceOf$1(e2, Event);
};
var isEmpty$1 = function(e2) {
...
function getDecimalPlaces(e2) {
  var t = "".concat(e2).match(/(?:\.(\d+))?(?:[eE]([+-]?\d+))?$/);
  return t ? Math.max(0, (t[1] ? t[1].length : 0) - (t[2] ? +t[2] : 0)) : 0;
}
function round(e2, t) {
  if (1 > t) {
    var n = getDecimalPlaces(t);
    return parseFloat(e2.toFixed(n));
  }
  return Math.round(e2 / t) * t;
}
var RangeTouch = (function() {
  function e2(t, n) {
    _classCallCheck(this, e2), is$1.element(t) ? this.element = t : is$1.string(t) && (this.element = document.querySelector(t)), is$1.element(this.element) && is$1.empty(this.element.rangeTouch) && (this.config = _objectSpread2({}, defaults$1, {}, n), this.init());
  }
  return _createClass(e2, [{
    ...
    key: "listeners",
    value: function(e3) {
      var t = this, n = e3 ? "addEventListener" : "removeEventListener";
      ["touchstart", "touchmove", "touchend"].forEach(function(e4) {
        t.element[n](e4, function(e5) {
          return t.set(e5);
        }, false);
      });
    }
    ...
    key: "get",
    value: function(t) {
      if (!e2.enabled || !is$1.event(t)) return null;
      var n, r2 = t.target, i2 = t.changedTouches[0], o2 = parseFloat(r2.getAttribute("min")) || 0, s2 = parseFloat(r2.getAttribute("max")) || 100, u2 = parseFloat(r2.getAttribute("step")) || 1, c2 = r2.getBoundingClientRect(), a2 = 100 / c2.width * (this.config.thumbWidth / 2) / 100;
      return 0 > (n = 100 / c2.width * (i2.clientX - c2.left)) ? n = 0 : 100 < n && (n = 100), 50 > n ? n -= (100 - 2 * n) * a2 : 50 < n && (n += 2 * (n - 50) * a2), o2 + round(n / 100 * (s2 - o2), u2);
    }
  }, {
    key: "set",
    value: function(t) {
      e2.enabled && is$1.event(t) && !t.target.disabled && (t.preventDefault(), t.target.value = this.get(t), trigger(t.target, "touchend" === t.type ? "change" : "input"));
    }
  }], [{
    key: "setup",
    value: function(t) {
      var n = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {}, r2 = null;
      if (is$1.empty(t) || is$1.string(t) ? r2 = Array.from(document.querySelectorAll(is$1.string(t) ? t : 'input[type="range"]')) : is$1.element(t) ? r2 = [t] : is$1.nodeList(t) ? r2 = Array.from(t) : is$1.array(t) && (r2 = t.filter(is$1.element)), is$1.empty(r2)) return null;
      var i2 = _objectSpread2({}, defaults$1, {}, n);
      if (is$1.string(t) && i2.watch) {
        var o2 = new MutationObserver(function(n2) {
          Array.from(n2).forEach(function(n3) {
            Array.from(n3.addedNodes).forEach(function(n4) {
              is$1.element(n4) && matches$1(n4, t) && new e2(n4, i2);
            });
          });
        });
...
function getAttributesFromSelector(sel, existingAttributes) {
  ...
  sel.split(",").forEach((s2) => {
    const selector = s2.trim();
...
function toggleClass(element, className, force) {
  if (is.nodeList(element)) {
    return Array.from(element).map((e2) => toggleClass(e2, className, force));
  }
  ...
  setup() {
    ...
    Object.defineProperty(player.media, "quality", {
      get() {
        ...
        const source2 = sources.find((s2) => s2.getAttribute("src") === player.source);
      ...
      set(input) {
        ...
        if (player.config.quality.forced && is.function(player.config.quality.onChange)) {
          ...
          const sources = html5.getSources.call(player);
          const source2 = sources.find((s2) => Number(s2.getAttribute("size")) === input);
          if (!source2) {
            return;
          }
          const {
...
var controls = {
  ...
  setQualityMenu(options) {
    ...
    this.options.quality.sort((a2, b) => {
      const sorting = this.config.quality.options;
      return sorting.indexOf(a2) > sorting.indexOf(b) ? 1 : -1;
    }).forEach((quality) => {
  ...
  setSpeedMenu() {
    ...
    this.options.speed = this.options.speed.filter((o2) => o2 >= this.minimumSpeed && o2 <= this.maximumSpeed);
...
var captions = {
  ...
  findTrack(languages, force = false) {
    ...
    const sorted = Array.from(tracks).sort((a2, b) => sortIsDefault(b) - sortIsDefault(a2));
    let track;
  ...
  constructor(_player) {
    ...
    _defineProperty$1(this, "controls", () => {
      ...
      if (elements.fullscreen) {
        Array.from(elements.fullscreen.children).filter((c2) => !c2.contains(elements.container)).forEach((child) => {
  ...
  (function(module, exports) {
    (function(root, factory) {
      ...
      function subscribe(bundleIds, callbackFn) {
        ...
        var depsNotFound = [], i2 = bundleIds.length, numWaiting = i2, fn, bundleId, r2, q;
      ...
      function loadFile(path, callbackFn, args, numTries) {
        var doc = document, async = args.async, maxTries = (args.numRetries || 0) + 1, beforeCallbackFn = args.before || devnull, pathname = path.replace(/[\?|#].*$/, ""), pathStripped = path.replace(/^(css|img|module|nomodule)!/, ""), isLegacyIECss, hasModuleSupport, e2;
        numTries = numTries || 0;
...
var youtube = {
  ...
  ready() {
    ...
    if (config.customControls) {
      const posterSrc = (s2) => `https://i.ytimg.com/vi/${videoId}/${s2}default.jpg`;
    ...
    player.embed = new window.YT.Player(player.media, {
      ...
      events: {
        ...
        onReady(event) {
          ...
          player.options.speed = speeds.filter((s2) => player.config.speed.options.includes(s2));
  ...
  constructor(player) {
    ...
    _defineProperty$1(this, "onAdsManagerLoaded", (event) => {
      ...
      Object.keys(google.ima.AdEvent.Type).forEach((type) => {
        this.manager.addEventListener(google.ima.AdEvent.Type[type], (e2) => this.onAdEvent(e2));
      });
      this.trigger("loaded");
    });
    ...
    _defineProperty$1(this, "getThumbnails", () => {
      return new Promise((resolve) => {
        ...
        if (is.function(src)) {
          ...
          const promises = urls.map((u2) => this.getThumbnail(u2));
...
function useAptor(ref, configuration, deps = []) {
  ...
  const { instantiate, destroy: destroy2, getAPI, params } = configuration;
  ...
  const api = (0, import_react.useMemo)(() => getAPI(instance, params), [instance]);
...
var i = Plyr;
var a = (e2, t) => {
  let n = new i(`.plyr-react`, (t == null ? void 0 : t.options) ?? {});
  return (t == null ? void 0 : t.source) && (n.source = t == null ? void 0 : t.source), n;
};
var o = (e2) => {
  e2 && e2.destroy();
};
...
var c = (e2) => e2 ? () => ({ plyr: e2 }) : () => new Proxy({ plyr: { source: null } }, { get: (e3, t) => t === `plyr` ? e3[t] : s });
function l(e2, t, r2 = null) {
  return useAptor(e2, { instantiate: a, getAPI: c, destroy: o, params: t }, r2 ?? [t.options, t.source]);
}
var u = e.forwardRef((e2, t) => {
  let { source: n, options: i2 = null, ...a2 } = e2, o2 = l(t, { source: n, options: i2 });
  return (0, import_jsx_runtime.jsx)(`video`, { ref: o2, className: `plyr-react plyr`, ...a2 });
});
u.displayName = `Plyr`;
export {
  u as Plyr,
